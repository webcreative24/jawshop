...
class SourceManager
{
    ...
    public function __construct(ModuleManager $moduleManager)
    {
        ...
        if ($this->isEnableMsi()) {
            ...
            $this->defaultStockProvider = ObjectManager::getInstance()->get(DefaultStockProviderInterface::class);
        }
    }
     ...
     * @return mixed
     */
    public function getDefaultStockProvider()
    {
        return $this->defaultStockProvider ?? false;
    }
