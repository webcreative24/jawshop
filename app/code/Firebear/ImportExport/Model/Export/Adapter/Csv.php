...
class Csv extends AbstractAdapter
{
    ...
    public function writeRow(array $rowData)
    {
        ...
        if (isset($rowData['extension_attributes']) &&
            $rowData['extension_attributes'] instanceof \Magento\Framework\DataObject) {
            $extensionAttribute = $rowData['extension_attributes'];
            $rowData['extension_attributes'] = json_encode($extensionAttribute->getData());
        }
