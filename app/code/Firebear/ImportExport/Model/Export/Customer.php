...
class Customer extends MagentoCustomer implements EntityInterface
{
     ...
     */
    const COLUMN_CUSTOMER_GROUP_NAME = '_customer_group_code';

    const COLUMN_TAX_CLASS_NAME = '_tax_class_name';

    const COLUMN_TAX_CLASS_ID = '_tax_class_id';
    ...
    /**
     * Add additional fields to a customer collection
     *
     * @return array|null
     */
    protected function _getExportAttributeCodes()
    {
        ...
        $customerAttributes = [
            self::COLUMN_CUSTOMER_GROUP_NAME,
            self::COLUMN_TAX_CLASS_NAME,
            self::COLUMN_TAX_CLASS_ID
        ];
    ...
    protected function _prepareEntityCollection(AbstractCollection $collection)
    {
        $collection
            ->joinTable(
                $collection->getTable('customer_group'),
                'customer_group_id = group_id',
                [self::COLUMN_CUSTOMER_GROUP_NAME => 'customer_group_code', self::COLUMN_TAX_CLASS_ID => 'tax_class_id']
            )
            ->joinTable(
                $collection->getTable('tax_class'),
                'class_id =' . self::COLUMN_TAX_CLASS_ID,
                [self::COLUMN_TAX_CLASS_NAME => 'class_name']
            );
