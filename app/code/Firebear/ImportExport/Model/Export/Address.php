...
class Address extends MagentoAddress implements EntityInterface
{
     ...
     * @return mixed
     */
    protected function prepareStreetFields($data)
    {
        $column = 'street';
    ...
    protected function _getHeaderColumns()
    {
        ...
        $streetIndex = array_search('street', $headers);
        $additionalHeaders = ['street1','street2','street3','street4'];
        array_splice($headers, $streetIndex + 1, 0, $additionalHeaders);
